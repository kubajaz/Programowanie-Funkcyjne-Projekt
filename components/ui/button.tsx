  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive cursor-pointer",
  {
    variants: {
      variant: {
        ...
        primary: "bg-yellow-600 text-primary-foreground hover:bg-yellow-600/90 border-yellow-700 border-b-4 active:border-b-0",
        primaryOutline: "bg-white text-yellow-700 hover:bg-slate-100",
        secondary: "bg-yellow-500 text-primary-foreground hover:bg-yellow-500/90 border-yellow-600 border-b-4 active:border-b-0",
        ...
        sidebar: "bg-transparent text-slate-500 border-2 boder-transparent hover:bg-slate-100 transition-none",
        sidebarOutline: "bg-yellow-700/15 text-yellow-700 border-yellow-500 border-2 hover:bg-yellow-700/20 transition-none"
      },
      size: {
